//! Native connector ABI for Delta Lake.
//!
...
const HEALTH_RESPONSE_JSON: &str =
    r#"{"ok":true,"engine":"deltaLake","abiVersion":1,"driverLinked":false}"#;
const DESCRIBE_RESPONSE_JSON: &str = concat!(
    r#"{"ok":true,"engine":"deltaLake","abiVersion":1,"driverLinked":false,"manifest":"#,
